...
#ifndef NLO_DEFAULT_DEVICE_HEAP_FRACTION_DISCRETE
#define NLO_DEFAULT_DEVICE_HEAP_FRACTION_DISCRETE 0.85
#endif

#ifndef NLO_DEFAULT_DEVICE_HEAP_FRACTION_INTEGRATED
#define NLO_DEFAULT_DEVICE_HEAP_FRACTION_INTEGRATED 0.60
#endif
